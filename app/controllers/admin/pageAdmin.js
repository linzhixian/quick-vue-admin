...
var { nav_menu } = require('../../../config/nav_menu');

var metaIndex = require('../../../config/meta');
...
async function exec(entityName, actionName, metaData, ctx) {
    ...
    if(metaData.serverMeta &&　metaData.serverMeta.serverHook) {
        console.log("exec",actionName,"serverMeta use serverHook")
        serverHook=metaData.serverMeta.serverHook
    }
